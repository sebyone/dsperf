...
typedef struct
{
    ...
    tmodel_t model_class;                  // 0 = unset, Features, Capacity, Continuity, etc.etc.
                                           //
    ...
    int pkt_mtu_size;                      // pkt's payload size (needs to be supported in testing routine)
    ...
    char local_if_str[_MAX_OPT_LEN];       // Protocol Local-IF/Addr
    ...
    bool listinterfaces;            // List interfaces
