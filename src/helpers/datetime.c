...
double now_millis()
{
    ...
    return ((double)__tv.tv_sec * 1000) + ((double)__tv.tv_usec / 1000.0);
}

double now_micros()
{
    gettimeofday(&__tv, NULL); // (https://man7.org/linux/man-pages/man2/settimeofday.2.html)
    return ((double)__tv.tv_sec * 1000000.0 + (double)__tv.tv_usec);
}

double now_seconds()
{
    gettimeofday(&__tv, NULL); // (https://man7.org/linux/man-pages/man2/settimeofday.2.html)
    return ((double)__tv.tv_sec + ((double)__tv.tv_usec / 1000000.0));
}
